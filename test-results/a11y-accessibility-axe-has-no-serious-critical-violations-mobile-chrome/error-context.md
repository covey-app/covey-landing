...
```
Error: scrollable-region-focusable: Scrollable region must have keyboard access
...
+         "html": "<div class=\"flex md:flex-wrap md:items-center gap-3 items-center overflow-x-auto no-scrollbar edge-fade md:overflow-visible md:[-webkit-mask-image:none] md:[mask-image:none]\" data-astro-cid-lcdefpme=\"\">",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".md\\:flex-wrap",
